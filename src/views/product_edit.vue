      ...
      <tbody>
        <tr v-for="product in products" :key="product.product_id">
          ...
          <td>
            <img
              v-if="product.image"
              :src="'http://localhost:8080/project_final/php_api/uploads/' + product.image"
              width="100"
            />
          </td>
          <td>
            ...
            <form @submit.prevent="saveProduct">
              ...
              <div class="mb-3">
                ...
                <div v-if="isEditMode && editForm.image">
                  ...
                  <img
                    :src="'http://localhost:8080/project_final/php_api/uploads/' + editForm.image"
                    width="100"
                  />
                </div>
              </div>
...
export default {
  ...
  setup() {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch("http://localhost:8080/project_final/php_api/api_product.php");
    ...
    return {
      products, loading, error, editForm, isEditMode,
      openAddModal, openEditModal, handleFileUpload, saveProduct, deleteProduct
    };
  }
};
</script>